      ...
      <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center">
                <span className="text-gray-600 text-xs">WW</span>
              </div>
              <div>
                <div className="text-sm font-medium">Wade Warren</div>
                <div className="text-xs text-gray-500">VISA 4293 3242 ****</div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border">
          <div className="flex justify-between items-start mb-3">
            <div>
              <div className="text-xs text-gray-500 mb-1">Highlight Feeds</div>
