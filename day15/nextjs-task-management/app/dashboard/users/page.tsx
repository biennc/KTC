    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-3 border-b-3 border-indigo-500 mx-auto mb-3"></div>
          <div className="space-y-1">
            <h3 className="text-md font-medium text-gray-700">Loading Users...</h3>
            <p className="text-xs text-gray-500">Fetching user management data</p>
          </div>
        </div>
      </div>
    )
